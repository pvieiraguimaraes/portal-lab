...
import br.ueg.portalLab.util.control.MessagesControl;
import br.ueg.portalLab.util.control.SubController;
import br.ueg.portalLab.util.control.ValidatorControl;
import br.ueg.portalLab.util.reflection.Reflection;
import br.ueg.portalLab.view.managed.MB;
...
public class GenericControl <E extends Entity> {
	...
	public GenericControl(MessagesControl pMessages, ListingControl<E> pListing, MB<E> pView) {
	 ...
	 * @param vMB
	 */
	public void mapManagerBeanToEntity(E entity, MB<E> vMB){ 
			...
			for (Field field : fields) {
				if (field.getAnnotation(br.ueg.portalLab.util.annotation.AttributeView.class) != null) {
					try {
						...
						String fieldName = field.getAnnotation(br.ueg.portalLab.util.annotation.AttributeView.class).key();
