...
public class CrudWindow extends Window implements IFormWindow {
	...
	private String titulo = "Manutençãoo";
	 ...
	 * div listitem (que está na definição  da janela utilizando o compoente
	...
	/**
	 * faz a construçãoo do cabeçalho(listheader) da janela, pegando o conteudo
